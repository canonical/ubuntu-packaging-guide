# -*- coding: utf-8 -*-
#
# ubuntu-packaging-guide documentation build configuration file, created by
...
copyright = u'2010-2014 , ' + authors + ', ' + licence
...
html_static_path = ['_static', 'translators.html']
...
htmlhelp_basename = 'ubuntu-packaging-guidedoc'
...
latex_documents = [
  ('ubuntu-packaging-guide/index', 'ubuntu-packaging-guide.tex', u'Ubuntu Packaging Guide',
   u'Ubuntu Developers', 'manual'),
]

# The name of an image file (relative to this directory) to place at the top of
# the title page.
latex_logo = 'images/logo-ubuntu_cof-orange-hex.png'
